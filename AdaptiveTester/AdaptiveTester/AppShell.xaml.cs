...
using AdaptiveTester.Controls;
using AdaptiveTester.Views;
        ...
        private List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
                new NavMenuItem()
                {
                    ...
                    Label = "ProsiseSample",
                    DestPage = typeof(ProsiseSamplePage),
                    PageToken = "ProsiseSample"
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.SolidStar,
                    Label = "BugnionSample1",
                    DestPage = typeof(BugnionSample1Page),
                    PageToken = "BugnionSample1"
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.SolidStar,
                    Label = "BugnionSample2",
                    DestPage = typeof(BugnionSample2Page),
                    PageToken = "BugnionSample2"
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.SolidStar,
                    Label = "ResponsiveGrid",
                    DestPage = typeof(ResponsiveGridPage),
                    PageToken = "ResponsiveGrid"
                },
            });
