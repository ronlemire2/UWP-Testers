...
namespace Ch07_Asynchronicity.Views {
    ...
    /// </summary>
    public sealed partial class WordFreqPage : Page {
        ...
        async void OnStartButtonClick(object sender, RoutedEventArgs args) {
            ...
            try {
                ...
                //StorageFile storageFile = await localFolder.CreateFileAsync("MobyDick.txt", CreationCollisionOption.OpenIfExists);
                //RandomAccessStreamReference streamRef = RandomAccessStreamReference.CreateFromFile(storageFile);
