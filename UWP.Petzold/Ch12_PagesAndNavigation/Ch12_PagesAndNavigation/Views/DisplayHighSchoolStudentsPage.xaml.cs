...
namespace Ch12_PagesAndNavigation.Views {
    ...
    /// </summary>
    public sealed partial class DisplayHighSchoolStudentsPage : Page {
        public DisplayHighSchoolStudentsPage() {
        ...
        private void OnGridViewItemClick(object sender, ItemClickEventArgs e) {
            this.Frame.Navigate(typeof(StudentPage), e.ClickedItem);
        }
    }
}
