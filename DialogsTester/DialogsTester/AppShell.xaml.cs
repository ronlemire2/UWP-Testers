...
using DialogsTester.Controls;
using DialogsTester.Views;
        ...
        private List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
                new NavMenuItem()
                {
                    ...
                    Label = "Confirmation",
                    DestPage = typeof(ConfirmationPage),
                    PageToken = "Confirmation"
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.OutlineStar,
                    Label = "Notification",
                    DestPage = typeof(NotificationPage),
                    PageToken = "Notification"
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.OutlineStar,
                    Label = "SearchParameters",
                    DestPage = typeof(SearchParametersPage),
                    PageToken = "SearchParameters"
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.OutlineStar,
                ...
                new NavMenuItem()
                {
                    Symbol = Symbol.OutlineStar,
                    Label = "TermsOfUse",
                    DestPage = typeof(TermsOfUsePage),
                    PageToken = "TermsOfUse"
                },
            });
